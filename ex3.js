...
app.get('/products', (req, res) => {
  ...
  if (maxPrice === null && limit === null) {
    return res.json(products)
  }
  const priceFiltered = maxPrice ? products.filter(product => product.price <= maxPrice) : products;
  const limitedProducts = limit ? priceFiltered.slice(0, limit) : priceFiltered
...
app.listen(4000, () => {
  console.log("runnnnninnnnnggggg is server !");
})